  ...
  return (
    <footer
      className="flexCenter flex-col 
        border-t dark:border-nft-black-1 
    ...
    >
      <div className="w-full minmd:w-4/5 flex flex-row md:flex-col sm:px-4 px-16">
        <div className="flexStart flex-1 flex-col">
          ...
          <div
            ...
            md:w-full minlg:w-557 w-357 
            mt-6 dark:bg-nft-black-2 
            bg-white border dark:border-nft-black-2 
          ...
          >
            ...
            px-4 rounded-md dark:text-white 
            text-nft-black font-normal 
      ...
      <div
        ...
        mt-5 border-t dark:border-nft-black-1 
        border-nft-gray-1 sm:px-4 px-16"
      >
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
            NFTLite. All rights reserved.
          </p>
          <div className="flex flex-row mt-4">
            {[Discord, Instagram, Telegram, Twitter].map((image, index) => (
